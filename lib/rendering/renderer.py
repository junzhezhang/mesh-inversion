...
def ortho_projection(points_bxpx3, faces_fx3):
    ...
    xy_bxpx3 = points_bxpx3 # xyz [10, 482, 3]
    xy_bxpx2 = xy_bxpx3[:, :, :2] # xy

    # 1st, 2nd, 3rd point of the faces; concat
...
class Renderer(nn.Module):
    ...
    def forward(self, points, uv_bxpx2, texture_bx3xthxtw, ft_fx3=None, background_image=None, return_hardmask=False):
        ...
        # print(points3d_bxfx9.shape,points2d_bxfx6.shape, normalz_bxfx1.shape,uv_bxfx9.shape)
        # torch.Size([16, 960, 9]) torch.Size([16, 960, 6]) torch.Size([16, 960, 1]) torch.Size([1, 960, 9])
        # torch.Size([1, 960, 9]) torch.Size([1, 960, 6]) torch.Size([1, 960, 1]) torch.Size([1, 960, 9])
